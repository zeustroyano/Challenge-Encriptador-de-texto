function encriptar(traduccion){
    ...
    // Obtiene el elemento textarea con el ID "texto"
var textarea = document.querySelector("#texto"); 

// Obtiene el valor del textarea
const texto = textarea.value; 

// Obtiene el elemento con el ID "default" (presumiblemente un área de visualización)
var area_default = document.querySelector("#default"); 

// Obtiene el elemento con el ID "result" (presumiblemente donde se mostrará el resultado)
var area_result = document.querySelector("#result"); 

// Obtiene el elemento con el ID "texto_out" (presumiblemente un elemento de salida para texto)
...
// Objeto para almacenar las traducciones de cada vocal.
